--- uboot-pristine/cpu/arm926ejs/WPCM450/hermon_mac_sg007.c	1969-12-31 16:00:00.000000000 -0800
+++ uboot-changed/cpu/arm926ejs/WPCM450/hermon_mac_sg007.c	2009-05-14 10:30:26.000000000 -0700
@@ -0,0 +1,911 @@
...
+		printf("Full Duplex\n");
+	}
+//	else if (GetLinkStatus(dev->name))	// joe
+	else if( strcmp( dev->name, "wpcm_eth0") == 0 )	// joe
+ 	{
