--- uboot-old/include/wpcm450/hwdef.h	1969-12-31 17:00:00.000000000 -0700
+++ uboot-new/include/wpcm450/hwdef.h	2008-08-02 19:06:45.000000000 -0500
@@ -0,0 +1,216 @@
+/*
...
+#define WPCM_BAUD_115200	    ((WPCM_UART_CLOCK /1843200)-2)
+#define WPCM_BAUD_57600	    ((WPCM_UART_CLOCK /921600)-2)
+#define WPCM_BAUD_38400	    ((WPCM_UART_CLOCK /614400)-2)
+#define WPCM_BAUD_19200	    ((WPCM_UART_CLOCK /307200)-2)
+#define WPCM_BAUD_14400	    ((WPCM_UART_CLOCK /230400)-2)
+#define WPCM_BAUD_9600		    ((WPCM_UART_CLOCK /153600)-2)
+
+
+/*----------------------------------------------------------------
...
+
+/* GCR INTCR2 register fields  */
+#define INTCR2_SP1_SI2_BIT 16
+#define INTCR2_SDSD			0
+
...
+
+#define CLK_HUART_SRC_P     10
+#define CLK_HUART_SRC_S      1
